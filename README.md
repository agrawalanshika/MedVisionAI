...
🎯<u> **Motivation** </u> Radiological diagnosis is time-intensive and expertise-dependent. MedVisionAI was built to explore how AI can assist — not replace — clinicians by providing fast, interpretable predictions across multiple imaging modalities from one unified tool.
